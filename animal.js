...
async function init() {
    ...
    try {
        ...
        document.getElementById('loading').textContent = "Error loading model. Check console for details. Ensure 'my_model' folder exists with model.json and metadata.json.";
        console.error(e);
    }
}
